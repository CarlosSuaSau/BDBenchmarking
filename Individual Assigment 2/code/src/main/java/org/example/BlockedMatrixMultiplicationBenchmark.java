...
public class BlockedMatrixMultiplicationBenchmark {
    ...
    @Benchmark
    public double[][] blockedMultiplication() {
        return BlockedMatrixMultiplication.multiplyBlocked(A, B, blockSize, sparsityLevel > 0);
    }
    ...
    public void saveResults() {
        try (FileWriter writer = new FileWriter("benchmark_results.txt", true)) {
            ...
            writer.write("Blocked     Matrix Size: " + matrixSize + ", Block Size: " + blockSize +
